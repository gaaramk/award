...
const navItems = ["Home", "Nexus", "Vault", "Prologue", "Contact"];

const Navbar = () => {
  const [isAudioPlaying, setIsAudioPlaying] = useState(false);
  const [isIndicatorAvtive, setIsIndicatorAvtive] = useState(false);
  ...
  const toggleAudio = () => {
    ...
    setIsIndicatorAvtive((prev) => !prev);
  };
